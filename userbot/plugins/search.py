...
from userbot.events import techno05, rekcah05
from userbot import CMD_HELP, ALIVE_NAME, PM_MESSAGE, techno_NAME, techno_MSG, ORI_MSG, bot, TEMP_DOWNLOAD_DIRECTORY, BOTLOG, BOTLOG_CHATID
techno_NNAME = str(techno_NAME) if techno_NAME else str(techno_MSG)
...
from userbot.techno_main.commands import progress
from userbot.techno_main.extra.google_images_download import googleimagesdownload
...
try:
   from userbot.techno_main.commands import meaning
except:
   pass
...
@techno.on(rekcah05(pattern=f"app (.*)", allow_sudo=True))
@techno05(outgoing=True, pattern="^.app (.*)")
async def apk(e):
...
@techno.on(rekcah05(pattern=f"ggl (.*)", allow_sudo=True))
@techno05(outgoing=True, pattern="^.ggl (.*)")
...
@techno05(outgoing=True, pattern="^\.currency (.*)")
@techno.on(rekcah05(pattern=f"currency (.*)", allow_sudo=True))
...
@techno05(outgoing=True, pattern="^.img (.*)")
@techno.on(rekcah05(pattern=f"img (.*)", allow_sudo=True))
...
@techno.on(rekcah05(pattern=f"movie (.*)", allow_sudo=True))
...
@techno.on(rekcah05(pattern=f"google (.*)", allow_sudo=True))
...
@techno.on(rekcah05(pattern=f"wiki (.*)", allow_sudo=True))
@techno05(outgoing=True, pattern=r"^\.wiki (.*)")
...
@techno.on(rekcah05(pattern=f"ud (.*)", allow_sudo=True))
@techno05(outgoing=True, pattern="^\.ud (.*)")
...
@techno05(outgoing=True, pattern="^.magisk$")
@techno.on(rekcah05(pattern=f"magisk$", allow_sudo=True))
...
@techno05(outgoing=True, pattern=r"^.specs(?: |)([\S]*)(?: |)([\s\S]*)")
@techno.on(rekcah05(pattern=f"specs(?: |)([\S]*)(?: |)([\s\S]*)", allow_sudo=True))
async def devices_specifimions(request):
    lazy = request ; sender = await lazy.get_sender() ; me = await lazy.client.get_me()
    if not sender.id == me.id:
        rkp = await lazy.reply("`processing...`")
...
@techno.on(rekcah05(pattern=f"song2(?: |$)(.*)", allow_sudo=True))
async def _(event):
    rksong = event.pattern_match.group(1)  
    rkkk= await event.reply(f"`{techno_NNAME}: ` **Finding {rksong} in world wide please wait........**")
...
@techno.on(rekcah05(pattern=f"mean(?: |$)(.*)", allow_sudo=True))
@techno05(outgoing=True, pattern="^.mean(?: |$)(.*)")
async def dic(event):
...
@techno05(outgoing=True, pattern=r"^\.reverse(?: |$)(\d*)")
@techno.on(rekcah05(pattern=f"reverse(?: |$)(\d*)", allow_sudo=True))
